...
let pvr = [
    {
        ...
        date: 18,
        img: 'images/img/jawan.jpg',
        video: 'images/video/Jawan Official Trailer-(HDvideo9).mp4',
        background: 'images/img/bg.png',
    },
    {
        pvr: 'PVR Vegus',
        movie: 'Gadar2',
        ...
        price: [ 800, 800, 560, 560, 560, 560, 430, 430 ],
        date: 18,
        img: 'images/img/Gadar2.jpg',
        video: 'images/video/Gadar2 Official Trailer - 11th August - Sunny Deol - Ameesha Patel - Anil Sharma - Zee Studios.mp4',
        background: 'images/img/gadar_bg.jpg',
    },
    {
        pvr: 'PVR Vegus',
        movie: 'Jawan',
...
document.getElementById('book_ticket').addEventListener('click', () => {
    Array.from(document.getElementsByClassName('selected')).forEach(el => {
      ...
      <div class="barcode">
        ...
        <div class="tic_details">
          ...
          <h5 class="pvr"> <span>Babal</span>Cinemas</h5>
          <h1>Jawan</h1>
          <div class="seat_det">
             <div class="seat_cr">
              <h6>Row</h6>
             ...
             <div class="seat_cr">
              <h6>Date</h6>
              <h6> ${main_date} <span>Sept</span> </h6>
            </div>
            <div class="seat_cr">
              <h6>Time </h6>
              <h6>11:30 <span>pm</span>
              </h6>
            </div>
    ...
    document.getElementById('ticket').appendChild(tic);
      ...
      JsBarcode(`#${seat_sr}${seat_no}barcode`,`${seat_sr.toLocaleUpperCase()}${seat_no}${seat_price}${main_date}0923`);
    })
